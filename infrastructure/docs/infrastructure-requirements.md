...
| Jellyfin | `500m` | `2` | `1Gi` | `4Gi` | `0` | `0` | Initial sizing for browser-accessible application demonstration without assuming heavy transcoding workload. |
...
- Jellyfin is deployed for application availability and demonstration, not GPU-backed media processing in this repository state.
...
- `kubectl describe pod` output for PostgreSQL, MLflow, and Jellyfin
