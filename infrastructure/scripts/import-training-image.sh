...
Build the training image from training/Dockerfile, tag it with the full
containerd-visible reference, and import it into the k3s/containerd runtime.

Environment variables:
  IMAGE_REF     Full image reference to import. Default: docker.io/library/jellyfin-training:latest
